...
ALIVE_MSG = [
    "`   𝐂  𝐑  Ꮻ  𝐋  Ꮻ  𝐊   Userbotunuz çalışıyor ve sana bişey demek istiyor.. Seni seviyorum` **{owensahip}** ❤️ \n Bot Versiyonu: {owen} ",
    "🎆 `  𝐂  𝐑  Ꮻ  𝐋  Ꮻ  𝐊  Endişelenme! Seni yanlız bırakmam.` **{owensahip}**, `OwenUserbot çalışıyor.` \n Bot Versiyonu: {owen} ",
    "`⛈️ 🐊  𝐂  𝐑  Ꮻ  𝐋  Ꮻ  𝐊  🐊 Elimden gelenin en iyisini yapmaya hazırım`, **{owensahip}** \n Bot Versiyonu: {owen} ",
    "✨ `🐊  𝐂  𝐑  Ꮻ  𝐋  Ꮻ  𝐊  🐊  sahibinin emirlerine hazır...` \n Bot Versiyonu: {owen} ",
    "`🐊  𝐂  𝐑  Ꮻ  𝐋  Ꮻ  𝐊  🐊 Şuan en gelişmiş userbotun düzenlediği mesajı okuyor olmalısın` **{owensahip}**. \n Bot Versiyonu: {owen} ",
    "`🐊  𝐂  𝐑  Ꮻ  𝐋  Ꮻ  𝐊  🐊 Benimi Aramıştın ❓ Ben Buradayım Merak Etme` \n Bot Versiyonu: {owen} "
]
...
LOGS.info("+===========================================================+")
LOGS.info("|                     ✨🐊  𝐂  𝐑  Ꮻ  𝐋  Ꮻ  𝐊  🐊 Userbot✨                       |")
LOGS.info("+==============+==============+==============+==============+")
LOGS.info("|                                                            |")
LOGS.info("Bot işləyir! Herhangi bir sohbete .alive yazarak Test edin."
          " Yardıma İhtiyacınız varsa, Destek grubumuza gelin t.me/crolokSupport")
